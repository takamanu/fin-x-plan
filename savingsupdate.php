        ...
        if($result){
            echo "
                <script>
                    ...
                    document.location.href = 'savings.php';
                </script>
            ";
        }
        else{
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col d-flex justify-content-start input-group flex-nowrap">
                    ...
                    <input type="text" class="form-control" id="target" name="target" required value="<?= $row["target"]; ?>" aria-describedby="emailHelp">
                </div>
            </div> 
            <div class="row top-buffer">
                <div class="col d-flex justify-content-start">
